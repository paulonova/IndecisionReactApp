...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function handlePick() {
            ...
            this.setState(function () {
                var randNumber = Math.floor(Math.random() * _this2.state.options.length);
                var option = _this2.state.options[randNumber];
                return alert(option);
            });
        }
    }, {
...
var AddOption = function (_React$Component6) {
    ...
    function AddOption(props) {
        ...
        _this7.handleAddOptionComponent = _this7.handleAddOptionComponent.bind(_this7);
        _this7.state = {
            error: undefined
        };
        return _this7;
    ...
    _createClass(AddOption, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'form',
                    { onSubmit: this.handleAddOptionComponent },
